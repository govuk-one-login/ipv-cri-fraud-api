...
import static uk.gov.di.ipv.cri.fraud.library.metrics.ThirdPartyAPIEndpointMetricType.API_RESPONSE_LATENCY;
...
public enum ThirdPartyAPIEndpointMetric {
    ...
    TOKEN_RESPONSE_LATENCY(TOKEN, API_RESPONSE_LATENCY),
    ...
    // To keep backward compatible with existing metric name do no use withEndpointPrefix (eq
    // API_RESPONSE_LATENCY)
    THIRD_PARTY_FRAUD_RESPONSE_LATENCY(FRAUD_V1, API_RESPONSE_LATENCY),
    ...
    // To keep backward compatible with existing metric name do no use withEndpointPrefix (eq
    // API_RESPONSE_LATENCY)
    THIRD_PARTY_PEP_RESPONSE_LATENCY(PEP_V1, API_RESPONSE_LATENCY),
